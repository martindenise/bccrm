...
// Style Sheet
document.write('<link rel="stylesheet" type="text/css" href="' + wyzzStyle + '">\n');

// TOOLBARS ARRAYS
// Order of available commands in toolbar
// Remove from this any buttons not required in your application
var buttonName = new Array("font","headers","separator","bold","italic","underline","strikethrough","separator","cut","copy","paste","separator","justifyleft","justifycenter","justifyright","justifyfull","indent","outdent","separator","insertunorderedlist","insertorderedlist","separator","link","insertimage");

// Order of available commands in toolbar2
// Remove from this any buttons not required in your application
var buttonName2 = new Array("undo","redo","specialchar","separator","forecolor","backcolor","separator","inserthorizontalrule","separator","removeformat","separator","upsize","downsize","separator","htmlmode");
...
function make_wyzz(textareaID) {
  ...
  for (btn in buttonName2) {
    ...
    if(buttonName2[btn] == "separator") {
      toolbar2 += '<td class="separator" style=" padding:0;">&nbsp;</td>';
      } else {
      toolbar2 += '<td style="width: 22px; padding:0;"><img src="' + iconsPath +buttonName2[btn]+ '.gif" border=0 unselectable="on" title="' +buttonName2[btn]+ '" id="' +buttonName2[btn]+ '" class="button" onClick="formatText(this.id,\'' + n + '\');" onmouseover="if(className==\'button\'){className=\'buttonOver\'};" onmouseout="if(className==\'buttonOver\'){className=\'button\'};" unselectable="on" width="20" height="20"></td>';
      }
  }
  toolbar2 += '<td style=" padding:0;">&nbsp;</td></tr>';

// the foreground color picker
  var swatchcount = 0;
  toolbar2 += '<tr><td colspan=' + colNumbers + ' style=" padding:0;">';
  toolbar2 += '<div id="colorpicker' + n + '" class="colorpicker" style="display:none">';
    ...
    toolbar2 += '<img class="closebutton" src="' + iconsPath + 'close.gif" border=0 onclick="closeColorPicker(\'colorpicker' + n + '\')"></div>';
  ...
  toolbar2 += '<img class="closebutton" src="' + iconsPath + 'close.gif" border=0 onclick="closeColorPicker(\'colorbackpicker' + n + '\')"></div>'; 
  // the font picker
  ...
  toolbar2 += '<img class="closebutton" src="' + iconsPath + 'close.gif" border=0 onclick="closeColorPicker(\'fontpicker' + n + '\')"></div>'; 
  ...
  toolbar2 += '</tr></table><br><img class="closebutton" src="' + iconsPath + 'close.gif" border=0 onclick="closeColorPicker(\'specialpicker' + n + '\')"></div>'; 
  // the header picker
  ...
  toolbar2 += '<img class="closebutton" src="' + iconsPath + 'close.gif" border=0 onclick="closeColorPicker(\'headerpicker' + n + '\')"></div>'; 
  ...
  toolbar2 += '<div class="help"><h4><img src="' + iconsPath + 'wyzzicon.gif" align="middle">Wyzz v' + version + '</h4><br>&copy; 2007 <a href="http://www.wyzz.info" target=_blank>www.wyzz.info</a><br><br></div>';
  toolbar2 += '<img class="closebutton" src="' + iconsPath + 'close.gif" border=0 onclick="closeColorPicker(\'helpbox' + n + '\')"></div></td></tr></table>';   

// Create iframe for editor
var iframe = '<table cellpadding="0" cellspacing="0" border="0" style="width:' + wyzzW + 'px; height:' + wyzzH + 'px;border: 1px inset #dddddd;"><tbody style="border:0"><tr><td valign="top" style="padding:0">\n'
