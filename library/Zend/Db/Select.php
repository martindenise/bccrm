...
class Zend_Db_Select
{
    ...
    const TOTAL_ROWS	 = 'calcFoundRows';
    ...
    const SQL_TOTAL_ROWS = 'SQL_CALC_FOUND_ROWS';
    ...
    {
        $this->_parts[self::TOTAL_ROWS] = (bool) $flag;
        return $this;
    }    
    ...
    {
        if ($this->_parts[self::TOTAL_ROWS]) {
            $sql .= ' ' . self::SQL_TOTAL_ROWS;
        }
