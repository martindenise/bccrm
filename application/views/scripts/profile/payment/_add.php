...
?>
<form name="addPayment" action="%FORM_URL%/?type=%LEAD_TYPE%&id=%LEAD_ID%&from=quote" method="post">
<table width="200" border="0" cellspacing="0" class="tblStyle2" style="margin: auto;">
