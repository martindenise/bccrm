...
class Zend_View_Helper_HintDiv extends Zend_View_Helper_Abstract
{
	protected $returnHtml = '';
	protected $divHtml = '<div class="noteDiv">
						<div style="margin: auto; width: 20px; float:left">
						<img src="%APP_PATH%/images/icons/hint.png" style="margin-right: 40px;vertical-align:middle;" />
						</div>
						<div style="padding-left: 40px; margin:0"> %MESSAGE% </div>
						</div>';

	public function HintDiv($message)
    {
