...
class Model_DbTable_Graduates extends Zend_Db_Table_Abstract
{
    /** Table name */
    protected $_name    = 'graduates';
    protected $_db		= null;
		...
		$select = $this->_db->select()
					 ...
					 ->from(array('t1' => $this->_name),
					 		array("CONCAT_WS(' ',first_name,last_name)",
					 			  ...
					 			  "event_date",
					 			  "t3.name",
					 			  "(CASE t1.graduated WHEN 'Yes' THEN CONCAT('Yes - ',t1.completion_date) ELSE t1.graduated END)",
					 			  "id"
					 		))
